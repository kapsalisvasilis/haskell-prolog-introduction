...
%-----------------------------------------------------------------------------------------
%AM 4080 KAPSALIS VASILEIOS
%-- ASKHSH 1


twice(C,N) :- hosted(I1,Y1,C),hosted(I2,Y2,C),Y2>Y1,Distance1 is Y2-Y1,Distance1 >= N.


%Cities host
in2Cities(D) :- hosted(I1,Y1,C1),hosted(I2,Y2,C2),dif(C1,C2),country(C1,D),country(C2,D). 
%Continets 1
in3Continents(I) :- thisFindFirst(I,E1),I2 is I+1,thisFindFirst(I2,E2),I3 is I+2,thisFindFirst(I3,E3),dif(E1,E2),dif(E1,E3),dif(E2,E3).
%helper1 find CONTINENT
thisFindfirst(I,E) :- hosted(I,Y,C),country(C,D),continent(D,E).
